...
export function QuoteForm({ t }: QuoteFormProps) {
  ...
  const addItem = () => {
    ...
    const newItems = [
      ...items,
      { product_id: newItemId, quantity: newItemQty },
    ];
    ...
    <div className="lg:col-span-2 space-y-8">
      ...
      <div className="bg-white/[0.02] backdrop-blur-3xl border border-white/5 p-10 rounded-[3rem] shadow-2xl">
        ...
        <div className="space-y-3 mb-10 min-h-[100px]">
          ...
          {items.length === 0 && (
            <div className="flex flex-col items-center justify-center py-12 border-2 border-dashed border-white/5 rounded-[2rem]">
              ...
              <p className="text-white/10 text-sm font-black uppercase tracking-widest italic">
                {t.quotes.noItems}
              </p>
            </div>
          )}
        ...
        <div className="space-y-2 mb-8">
          <Label className="pl-2 text-[10px] uppercase font-black text-zinc-500 italic">
            {t.quotes.notesLabel}
          </Label>
          <textarea
            {...register("notes")}
